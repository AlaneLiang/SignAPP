...
public class DrawHookViewOut extends View {
    ...
    public DrawHookViewOut(Context context) {
        super(context);
    }

    public DrawHookViewOut(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DrawHookViewOut(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //设置画笔颜色
        paint.setColor(getResources().getColor(R.color.map));
        //设置圆弧的宽度
